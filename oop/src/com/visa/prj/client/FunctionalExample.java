...
@FunctionalInterface
interface Computation{ //interface with only one behaviour called functional interface
...
public class FunctionalExample {
	...
	public static void main(String[] args) {
		...
		//Lambda is short form of Anonymous class used only for functional interfaces
