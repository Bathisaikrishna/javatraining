...
public class ProductControllerTest {
	...
	@Autowired
	private MockMvc mockMvc; // create  mock object of MVC with dispatcher servlet, request handler. no need to start server
	
	@Test
	public void getProductsTest() throws Exception {
		List<Product> products = 
				Arrays.asList(new Product(1,"a","c1",500.00,100),
